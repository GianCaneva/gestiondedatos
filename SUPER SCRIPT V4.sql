...
BEGIN
	...
	INSERT INTO BIG_DATA.Reserva (cantidadNoches,fecha_Reserva_Desde,fecha_Reserva_Hasta,fecha_Reserva_Realizada,idTipoHabitacion,idHotel,idRegimen,idHabitacion,idCliente,idEstadoReserva,ultimaModificacionPor)
	VALUES
	( ABS(DATEDIFF(day,@FechaHasta,@FechaDesde)),@FechaDesde,@FechaHasta,@FechaReservaRealizada,@idTipoHab,@HotelId,@idRegimen,(select idHabitacion from BIG_DATA.Habitacion where numeroHab=@numeroHab and idHotel=@HotelId),@idCliente,1,@ultimaModificacionUsuario)
